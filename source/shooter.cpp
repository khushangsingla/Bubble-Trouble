#include "shooter.h"
Shooter::Shooter(double position_x, double position_y, double vx_, double height, double width, double head_radius, Color color_)
{
    // Shooter constructor
    color = color_;
...
void Shooter::move(double t, bool is_moving_left)
{
    // move the shooter
    double vel = vx;
    if (is_moving_left)
...
double Shooter::get_head_center_x()
{
    // return the x coordinate of the center of the head
    return head.getX();
}

double Shooter::get_head_center_y()
{
    // return the y coordinate of the center of the head
    return head.getY();
}

double Shooter::get_head_radius()
{
    // return the radius of the head
    return head.getRadius();
}

double Shooter::get_body_center_x()
{
    // return the x coordinate of the center of the body
    return body.getX();
}

double Shooter::get_body_center_y()
{
    // return the y coordinate of the center of the body
    return body.getY();
}

double Shooter::get_body_width()
{
    // return the width of the body
    return body.getWidth();
}

double Shooter::get_body_height()
{
    // return the height of the body
    return body.getHeight();
}
bool Shooter::check_if_dead(Bubble bubble){
    if(bubble.get_center_y()+bubble.get_radius()>head.getY()-head.getRadius() && bubble.get_center_x()+bubble.get_radius()>head.getX()-head.getRadius() && bubble.get_center_x()-bubble.get_radius()<head.getX()+head.getRadius()){
        return true;
    }
	return false;
